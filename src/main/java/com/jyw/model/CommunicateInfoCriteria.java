...
public class CommunicateInfoCriteria {
    /**
     * 排序字段
     */
     ...
     * 构造查询条件
     */
    public CommunicateInfoCriteria() {
    ...
    /**
     * 学员沟通记录communicate_info的基本动态SQL对象.
     */
    ...
    /**
     * 学员沟通记录communicate_info的动态SQL对象.
     */
