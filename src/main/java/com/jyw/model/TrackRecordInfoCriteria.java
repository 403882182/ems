...
public class TrackRecordInfoCriteria {
    /**
     * 排序字段
     */
     ...
     * 构造查询条件
     */
    public TrackRecordInfoCriteria() {
    ...
    /**
     * 跟踪记录信息track_record_info的基本动态SQL对象.
     */
    ...
    /**
     * 跟踪记录信息track_record_info的动态SQL对象.
     */
