...
<form action="" class="form-horizontal">
    ...
    <h5 class="page-header alert-info" style="padding:10px; margin:0px; margin-bottom:5px;">跟踪记录 ---> <a
            class="btn btn-info btn-xs" href="trackrecordinfo/loadadd.do">添加新记录</a></h5>
    <div class="row">
        <div class="col-sm-12">
            <table class="table">
                <tr>
    ...
    <h5 class="page-header alert-info" style="padding:10px; margin:0px; margin-bottom:5px;">试听记录---> <a
            class="btn btn-info btn-xs" href="auditioninfo/loadadd.do">添加新记录</a></h5>
    <div class="row">
        <div class="col-sm-12">
            <table class="table">
                <tr>
